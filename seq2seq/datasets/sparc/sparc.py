...
from seq2seq.lf_util.ssql.ssql_parser import SqlDictParser
...
class SParC(datasets.GeneratorBasedBuilder):
    ...
    def __init__(self, *args, writer_batch_size=None, **kwargs):
        ...
        self.global_idx = 0
        self.sql_dict_parser = SqlDictParser('data/sparc/tables.json', lower_column=True)

    def _info(self):
        features = datasets.Features(
            {
                "diag_id": datasets.Value("int32"),
