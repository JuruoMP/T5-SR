...
from seq2seq.lf_util.sql_dict_parser import SqlaugParser
...
class Spider(datasets.GeneratorBasedBuilder):
    ...
    def __init__(self, *args, writer_batch_size=None, **kwargs):
        ...
        self.sql_parser = SqlaugParser('data/spider/tables.json')
    ...
    def _split_generators(self, dl_manager):
        ...
        return [
            datasets.SplitGenerator(
                ...
                gen_kwargs={
                    "data_filepath": downloaded_filepath + "/spider_synonym/train_spider.json",
                    "db_path": downloaded_filepath + "/spider_synonym/tables.json",
                },
            ),
            datasets.SplitGenerator(
