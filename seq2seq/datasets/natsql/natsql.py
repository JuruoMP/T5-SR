...
_URL = "/data/juruo/dataset/spider.zip"#"https://drive.google.com/uc?export=download&id=1_AckYkinAnhqmRQtGsQgUKAnTHxxX5J0"


class Natsql(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        ...
        return [
            datasets.SplitGenerator(
                ...
                gen_kwargs={
                    "data_filepath": "data/natsql/train_spider.json",
            ...
            datasets.SplitGenerator(
                ...
                gen_kwargs={
                    "data_filepath": "data/natsql/dev.json",
                    "db_path": downloaded_filepath + "/spider/database",
                },
            ),
        ]
