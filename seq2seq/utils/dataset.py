...
class DataTrainingArguments:
    ...
    num_return_sequences: Optional[int] = field(
        default=1,
        metadata={
            "help":"https://discuss.huggingface.co/t/announcement-generationoutputs-scores-attentions-and-hidden-states-now-available-as-outputs-to-generate/3094"
        },
    )
    ...
    train_to_generate_sql: Optional[str] = field(
        default="middle_sql",
        metadata={"help": "是不是要产生原生的SQL"},
    )
    is_sql_fix_parser: bool = field(default=True, metadata={"help": "是不是要用table修正."})
...
class DataArguments:
    ...
    dataset_paths: Dict[str, str] = field(
        default_factory=lambda: {
            ...
            "spider_other": "seq2seq/datasets/spider_other",
            "sparc": "seq2seq/datasets/sparc",
            "cosql": "seq2seq/datasets/cosql",
            "dirty_sql": "seq2seq/datasets/dirty_sql",
            "natsql": "seq2seq/datasets/natsql"
        },
    ...
    metric_paths: Dict[str, str] = field(
        default_factory=lambda: {
            ...
            "translate": "./seq2seq/metrics/translate"
        },
...
def serialize_schema(
    ...
    if schema_serialization_type == "verbose":
        ...
        column_str_without_values = "{column}"
        value_sep = " , "
    elif schema_serialization_type == "juruo":
        db_id_str = " | {db_id}"
        table_sep = ""
        table_str = " | {table} : {columns} ,"
        column_sep = " , "
